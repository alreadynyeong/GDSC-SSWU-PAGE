  ...
  return (
    <Container>
      <PC>
        ...
        <Items>
          {TEAMS.map((t) => (
            <ItemContainer onClick={() => router.push(`/project?id=${t.team}`)}>
              <TeamImage>
                <img
                  src={`https://alreadynyeong.github.io/GDSC-SSWU-PAGE/Teams/${t.team}1.png`}
                  alt={""}
                  width={250}
                  height={309}
                />
      ...
      <Mobile>
        ...
        <Items>
          {TEAMS.map((t) => (
            <MobileItemContainer
              onClick={() => router.push(`/project?id=${t.team}`)}
            >
              <div>
                <img
                  src={`https://alreadynyeong.github.io/GDSC-SSWU-PAGE/Teams/${t.team}1.png`}
